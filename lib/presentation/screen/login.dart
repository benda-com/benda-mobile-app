...
class _LoginState extends State<Login> {
  ...
  bool isCorrectEmail(String em) {
    return em == "gyneco@gmail.com" || em == "pregnant@gmail.com";
  }

  bool isCorrectPassword(String em) {
    return em == "gyneco" || em == "pregnant";
  }
                            ...
                            SizedBox(
                              child: TextFormField(
                                ...
                                validator: (value) {
                                  ...
                                  if (!isCorrectEmail(value.toString())) {
                                    return "";
                                  }
                                  return null;
                                },
                            ...
                            Container(
                              child: TextFormField(
                                ...
                                validator: (value) {
                                  ...
                                  if (!isCorrectPassword(value.toString())) {
                                    return "";
                                  }
                                  return null;
                                },
                      ...
                      child: TextButton(
                        onPressed: () {
                          if (_formfield.currentState!.validate()) {
                            if (emailController.text == "gyneco@gmail.com" &&
                                passController.text == "gyneco") {
