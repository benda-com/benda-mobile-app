...
class WrightParametersModel {
  ...
  factory WrightParametersModel.fromRawJson(String str) =>
      WrightParametersModel.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory WrightParametersModel.fromJson(Map<String, dynamic> json) =>
      WrightParametersModel(
        age: json["age"],
        origin: json["origin"],
